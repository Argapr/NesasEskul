      ...
      <main className="mx-10 mt-[5rem]">
        <div className="grid grid-cols-4 gap-4">
          <div className="col-span-3 relative">
            <input type="text" placeholder="Cari Eskul" className="w-[71rem] px-4 py-4 rounded-lg focus:outline-none border border-[#fff] bg-transparent" />
          ...
          <div className="relative">
            ...
            <div className="pointer-events-none absolute inset-y-0 right-0 flex items-center justify-center px-2 h-[3.3rem] w-12 bg-white rounded-r-lg text-[#000]">
        ...
        <div className="mt-[2rem]">
          <div className="grid grid-cols-3 gap-4">
            <div className="h-[33rem] bg-[#fff] rounded-lg pt-5">
              <div className="h-[27rem] bg-black mx-5 overflow-hidden rounded-lg">
                <Image src="/1.jpg" alt="" height={700} width={480} objectFit="cover" className="rounded-lg" />
              </div>
              <div className="m-5 grid grid-cols-3 gap-4">
                <p className="col-span-2 text-3xl ms-2 font-semibold">Paskibra</p>
            ...
            <div className="h-[33rem] bg-[#fff] rounded-lg pt-5">
              ...
              <div className="m-5 grid grid-cols-3 gap-4">
                <p className="col-span-2 text-3xl ms-2 font-semibold">Marching Band</p>
                <button className="bg-[#2F2D2D] text-[#fff] font-semibold text-xl py-2 px-0 rounded-full">Detail</button>
              </div>
            </div>
            <div className="h-[33rem] bg-[#fff] rounded-lg pt-5">
              ...
              <div className="m-5 grid grid-cols-3 gap-4">
                <p className="col-span-2 text-3xl ms-2 font-semibold">Basket </p>
                <button className="bg-[#2F2D2D] text-[#fff] font-semibold text-xl py-2 px-0 rounded-full">Detail</button>
              </div>
            </div>
          </div>
