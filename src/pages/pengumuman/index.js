    ...
    <>
      ...
      <main>
        <div className="md:mx-[5rem] mx-2 grid md:grid-cols-5 gap-4 md:mt-[6rem] mt-[2rem]">
          <div className="p-3 rounded-lg w-full md:h-[32rem] h-[10rem] col-span-2 mt-2">
            ...
            <p className="mt-3 font-semibold text-[#ffffff] text-xl">Kategori</p>
            <div className="mx-2 mt-2">{/* Kategori-kategori di sini */}</div>
          </div>
